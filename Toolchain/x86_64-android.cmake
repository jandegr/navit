...
set(ANDROID_ARCH "x86_64" CACHE STRING "Android architecture")

find_program(CMAKE_C_COMPILER NAMES x86_64-linux-android-gcc x86_64-linux-android-gcc.exe)
find_program(CMAKE_CXX_COMPILER NAMES x86_64-linux-android-g++ x86_64-linux-android-g++.exe)
set(PKG_CONFIG_EXECUTABLE "x86_64-android-pkg-config")

get_filename_component(COMPILER_PATH ${CMAKE_C_COMPILER} PATH)

set(ANDROID_NDK "${COMPILER_PATH}/../../../../.." CACHE STRING "PATH to Andriod NDK")

set(NDK_ARCH_DIR "${ANDROID_NDK}/platforms/android-21/arch-x86_64")
