...
cmake -DCMAKE_TOOLCHAIN_FILE=$CMAKE_FILE -DCACHE_SIZE='(20*1024*1024)' -DAVOID_FLOAT=1 -DSAMPLE_MAP=n -DBUILD_MAPTOOL=n -Dpedestrian=n -DANDROID_API_VERSION=19 $SOURCE_PATH
make || exit 1
